...
static const char *funny_messages[][2] = {
	{"GOOMBA AND", "UNSTOPABLE"},
	{"CARESSALIE ID DO", "ANYTHING FOR YOU"},
	{"DONT BE", "A SADIST"},
	{"WHAT THE HELL", "THEYRE SISTERS"},
	{"THE TRAIN IS", "TAKING ME TO MC D"},
	{"HEHEHEHA", "SAYS MANGO"},
	{"CASS IS", "THE BAE"},
	{"TEN THINGS", "ABOUT CASS"},
	{"OFFSETS DONE BY", "UNSTOPABLE"},
	{"CASS LOVES", "PLAYSTATION MAGAZINE"},
	{"STOMPING", "THE COMPETETION IDK"},
	{"FUNNY SHIT", "FER FREE"},
	{"DOES HER DEMON FORM", "MAKER HER A FURRY"},
	{"ITS MORE MALICIOUS", "THAN DEEZ NUTZ"},
	{"USE A CONTROLLER", "PUSSY"},
	{"MAKING", "PANCAKES"},
	{"CASS IS", "BADASS"},
};
...
void Menu_Load(MenuPage page)
{
	...
	menu.heart = Char_heart_New(FIXED_DEC(0,1), FIXED_DEC(-50,1));
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					case 2:
					case 1:
						menu.font_bold.draw(&menu.font_bold, "RAMENNOODILES",   SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "BINA", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "MAGNUSSTROM",   SCREEN_WIDTH2, SCREEN_HEIGHT2,      FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "GOOMBAKUNGFU",      SCREEN_WIDTH2, SCREEN_HEIGHT2 + 16, FontAlign_Center);
						break;
					
					case 7:
						menu.font_bold.draw(&menu.font_bold, "COOL GUY",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
						Gfx_BlitTex(&menu.tex_ng, &src_ng, (SCREEN_WIDTH - 128) >> 1, SCREEN_HEIGHT2 - 16);
				//Fallthrough
					case 6:
					case 5:
						menu.font_bold.draw(&menu.font_bold, "WITH HELP FROM", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 64, FontAlign_Center);
				...
				//Fallthrough
					...
					case 15:
						menu.font_bold.draw(&menu.font_bold, "CASS", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 8, FontAlign_Center);
				//Fallthrough
					case 14:
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"3", StageId_3_1, "SADIST SISTER", {"BERZERKER", "POSSESSION", "TAKEOVER"}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_3_1, "BERZERKER"},
				{StageId_3_2, "POSSESSION"},
				{StageId_3_3, "TAKEOVER"},
				{StageId_2_1, "UGH CASS COVER"},
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_1, "VS CASS BY", false},
				{StageId_Clwn_1, "  RamenNoodiles", false},
				{StageId_Clwn_4, "  Bina", false},
				{StageId_Clwn_4, "  MagnusStrom", false},
				{StageId_2_4,    "PSX CASS BY", false},
