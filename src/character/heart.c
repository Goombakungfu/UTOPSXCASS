...
static const CharFrame char_heart_frame[] = {
	...
	{heart_ArcMain_Idle8, {0,    0,   256, 256}, {29, 106}},
	{heart_ArcMain_Idle9, {0,    0,   256, 256}, {29, 106}},
	{heart_ArcMain_Idle10, {0,    0,   256, 256}, {29, 106}},
};
...
Character *Char_heart_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		...
		"idle8.tim",   //heart_ArcMain_Idle1
		"idle9.tim",   //heart_ArcMain_Idle1
		"idle10.tim",   //heart_ArcMain_Idle1
		NULL
	};
