...
static const CharFrame char_xmasp_frame[] = {
	...
	{XmasP_ArcMain_Idle1, {0,   0, 256, 256}, {130, 182}}, //1 idle 2
	{XmasP_ArcMain_Idle2, {0,   0, 256, 256}, {130, 182}}, //2 idle 3
	{XmasP_ArcMain_Idle3, {0,   0, 256, 256}, {130, 182}}, //3 idle 4
	
	{XmasP_ArcMain_LeftA0, {0,   0, 256, 256}, {130, 182}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 256, 256}, {130, 182}}, //5 left a 2
	{XmasP_ArcMain_LeftB0, {0,   0, 256, 256}, {130, 182}}, //6 left b 1
	{XmasP_ArcMain_LeftB1, {0,   0, 256, 256}, {130, 182}}, //7 left b 2
	
	{XmasP_ArcMain_DownA0, {0,   0, 256, 256}, {130, 182}}, //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 256, 256}, {130, 182}}, //9 down a 2
	{XmasP_ArcMain_DownB0, {0,   0, 256, 256}, {130, 182}}, //10 down b 1
	{XmasP_ArcMain_DownB1, {0,   0, 256, 256}, {130, 182}}, //11 down b 2
	
	{XmasP_ArcMain_UpA0, {0,   0, 256, 256}, {130, 182}}, //12 up a 1
	{XmasP_ArcMain_UpA1, {0,   0, 256, 256}, {130, 182}}, //13 up a 2
	{XmasP_ArcMain_UpB0, {0,   0, 256, 256}, {130, 182}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 256, 256}, {130, 182}}, //15 up b 2
	
	{XmasP_ArcMain_RightA0, {0,   0, 256, 256}, {130, 182}}, //16 right a 1
	{XmasP_ArcMain_RightA1, {0,   0, 256, 256}, {130, 182}}, //17 right a 2
	{XmasP_ArcMain_RightB0, {0,   0, 256, 256}, {130, 182}}, //18 right b 1
	{XmasP_ArcMain_RightB1, {0,   0, 256, 256}, {130, 182}}, //19 right b 2
};
